...
public enum ExceptionMessage {
	...
	ERR_ATTENDANCE_TODAY_IS_DAYOFF("오늘은 연차를 신청한 날입니다. 출근이 기록되지 않습니다.", HttpStatus.BAD_REQUEST),
	ERR_ATTENDANCE_GET_OFF_NOT_AVAILABLE("출근 기록이 없으면 퇴근을 기록할 수 없습니다.", HttpStatus.BAD_REQUEST),
